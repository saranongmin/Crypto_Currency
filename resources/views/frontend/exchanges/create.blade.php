    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Your exchange displayed on Hedera.com</h2>
<p>Hedera displays known HBAR cryptocurrency wallets with varying functionality on its website, including hardware, software, custodial, and traditional offerings. Register your wallet below for a chance to be featured.</p>
  ...
  <div class="col-lg-10 mt-5 mt-lg-0">
            ...
            <form action="{{route('exchanges.store')}}" method="post">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="exchange_name" id="exchange_name" placeholder="Exchange Name" required>
              </div>
             ...
             <div class="form-group mt-3">
              ...
              <div class="form-group mt-3">
                <input type="file" class="form-control" name="logo" id="logo" placeholder="HIGH-RES LOGO URL *" required><br>
              </div>
             
              <div class="text"><button type="submit" class="btn btn-primary">Submit </button></div>
            </form>
